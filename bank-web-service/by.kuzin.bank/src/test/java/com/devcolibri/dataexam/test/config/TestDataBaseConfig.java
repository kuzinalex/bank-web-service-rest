...
public class TestDataBaseConfig {
    ...
    private static final String PROPERTY_NAME_DATABASE_URL = "jdbc:mysql://localhost:3306/bankdb";
    private static final String PROPERTY_NAME_DATABASE_USERNAME = "root";
    private static final String PROPERTY_NAME_DATABASE_PASSWORD = "root1234";
